...
function betterBreadcrumbs() {
  ...
  if(!is_child_page() && is_page() || is_category() || is_single()) {
    echo "<span>".bloginfo()."</span><span>".the_title()."</span>";
    return;
  }

  if(is_child_page()) {
    $showParentBread = get_field('show_parent_breadcrumb');
  ...
  if ($showParentBread == true && $parentBreadcrumb !="") {
  	echo "<span>".$parentBreadcrumb."</span>";
  }
